...
import "./CommentCLB.css";
import axios from "axios";


const CommentCLB = ({idPost}) => {
                ...
                <div className="d-flex align-items-center ms-3 mt-3">
                    <div>
                        {
                            dataUser.map((user, idx) => (
                                user.id_user === session.id_user && user.avatar !== null && <img src={user.avatar.slice(6)}className="rounded-circle me-2" width="35px"/> ||
                    ...
                    <div className="comment-border border">
                        <form className="d-flex align-items-center">
                            <textarea value={formComment.comment} className="comment-input rounded-1" placeholder="Viết bình luận" onChange={(e) => {
                                    ...
                                    dataCmt.map((cmtC, idx) => (
                                        ...
                                        <div className="content-comment ms-5 d-flex">
                                            <div>
                                                {
                                                    dataUser.map((user, idx) => (
                                                        user.id_user === cmtC.id_user && user.avatar !== null && <img src={user.avatar.slice(6)} className="rounded-circle me-2 mt-2" width="35px"/> ||
